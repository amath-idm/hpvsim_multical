...
def make_layer_probs(location=None, marriage_scale=1):
    ...
    if location == 'senegal':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
            0,   0, 0.1, 0.07, 0.05, 0.1, 0.1, 0.05, 0.05, 0.05, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01
        ])
    ...
    if location == 'south africa':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
            0,   0, 0.1, 0.8, 0.8, 0.6, 0.6, 0.5, 0.25, 0.2, 0.1, 0.05, 0.01, 0.01, 0.01, 0.01
        ])
    # if location == 'benin':
    #     layer_probs['c'][1] = np.array([
    #         # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
    ...
    if location == 'tanzania':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
            0,   0, 0.1, 0.25, 0.45, 0.7, 0.6, 0.6, 0.7, 0.8, 0.5, 0.4, 0.1, 0.1, 0.05, 0.01
        ])
    if location == 'togo':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
    ...
    if location == 'uganda':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
            0,   0, 0.1, 0.45, 0.4, 0.3, 0.3, 0.2, 0.2, 0.05, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01
        ])
    if location == 'zambia':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
    ...
    if location == 'zimbabwe':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
            0,   0, 0.1, 0.2, 0.2, 0.15, 0.15, 0.15, 0.15, 0.15, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01
        ])

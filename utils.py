...
def make_layer_probs(location=None, marriage_scale=1):
    ...
    if location == 'chad':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
            0,   0, 0.1, 0.15, 0.15, 0.1, 0.05, 0.05, 0.05, 0.05, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01
        ])
    if location == 'congo':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
            0,   0, 0.1, 0.8, 0.9, 0.6, 0.6, 0.5, 0.3, 0.2, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01
        ])
    if location == 'drc':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
    ...
    if location == 'mozambique':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
            0,   0, 0.1, 0.5, 0.3, 0.2, 0.1, 0.1, 0.1, 0.05, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01
        ])
    if location == 'nigeria':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
            0,   0, 0.1, 0.8, 0.7, 0.6, 0.2, 0.2, 0.2, 0.05, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01
        ])
    if location == 'rwanda':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
            0,   0, 0.1, 0.8, 0.4, 0.2, 0.2, 0.2, 0.2, 0.05, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01
        ])
    # if location == 'benin':
    #     layer_probs['c'][1] = np.array([
    #         # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
    ...
    if location == 'tanzania':
        layer_probs['c'][1] = np.array([
            # 0, 5,  10,  15,  20,  25,  30,  35,  40,  45,  50,  55,  60,  65,   70,   75
            0,   0, 0.1, 0.5, 0.5, 0.6, 0.6, 0.5, 0.6, 0.7, 0.5, 0.4, 0.1, 0.1, 0.05, 0.01
        ])
